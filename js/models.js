...
class User {
  ...
  constructor({
    ...
    this.favorites = favorites.map(x => new Story(x));
    this.ownStories = ownStories.map(x => new Story(x));
  ...
  static async signup(username, password, name) {
    ...
    const res = await axios.post(`${BASE_URL}/signup`,{ user: { username, password, name } } );
  ...
  static async login(username, password) {
    const res = await axios.post(`${BASE_URL}/login`,{ user: { username, password } });
    let { user } = res.data;
